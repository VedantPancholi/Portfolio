  ...
  return (
    <>
      <div className="fixed max-w-[90%] xl:max-w-[1223px] w-full z-10 select-none">
        <div className="flex justify-between items-center px-6 py-4 rounded-2xl bg-gradient-to-r from-[#fbfbfb1f] to-[#0b0b0b1f] mt-4 sm:mt-8 std-backdrop-blur">
          <Image
            src="/logo_svg.svg"
            width={32}  
            height={36}
          ...
          <div className="gap-5 text-xl hidden sm:flex">
            <Link target="_blank" href="https://www.linkedin.com/in/vedantpancholi/">
              <Icon icon="hugeicons:linkedin-01" />
            </Link>
            <Link target="_blank" href="https://github.com/VedantPancholi">
